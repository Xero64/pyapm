...
class Airfoil(object):
    ...
    def update(self, num: int=80):
        ...
        self.xu, self.yu = self.spline.interpolate_spline_points(slst1)
        self.xl, self.yl = self.spline.interpolate_spline_points(slst2)
        self.xu.reverse()
        self.yu.reverse()
        x1, y1 = self.xu, self.yu
        x2, y2 = self.xl, self.yl
