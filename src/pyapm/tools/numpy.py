...
def numpy_cwdp(pnts: Vector, veca: Vector, vecb: Vector,
               dirw: Vector, *, betx: float = 1.0,
               bety: float = 1.0, betz: float = 1.0,
               tol: float = 1e-12, cond: float = 0.0) -> 'NDArray':
...
def numpy_ctdv(pnts: Vector, veca: Vector, vecb: Vector,
               vecc: Vector, *, betx: float = 1.0,
               bety: float = 1.0, betz: float = 1.0,
               tol: float = 1e-12) -> Vector:
...
def numpy_ctdp(pnts: Vector, veca: Vector, vecb: Vector,
               vecc: Vector, *, betx: float = 1.0,
               bety: float = 1.0, betz: float = 1.0,
    ...
    cr = zeros(shape(cm))
    reciprocal(cm, where=cmnotzero, out=cr)
...
def numpy_ctdf(pnts: Vector, veca: Vector, vecb: Vector,
               vecc: Vector, *, betx: float = 1.0,
               bety: float = 1.0, betz: float = 1.0,
...
def numpy_ctsp(pnts: Vector, veca: Vector, vecb: Vector,
               vecc: Vector, *, betx: float = 1.0,
               bety: float = 1.0, betz: float = 1.0,
               tol: float = 1e-12, cond: float = -1.0) -> 'NDArray':
...
def numpy_ctsv(pnts: Vector, veca: Vector, vecb: Vector,
               vecc: Vector, *, betx: float = 1.0,
               bety: float = 1.0, betz: float = 1.0,
               tol: float = 1e-12, cond: float = 0.0) -> Vector:
...
def numpy_ctsf(pnts: Vector, veca: Vector, vecb: Vector,
               vecc: Vector, *, betx: float = 1.0,
               bety: float = 1.0, betz: float = 1.0,
               tol: float = 1e-12, cond: float = 0.0) -> Flow:
...
def numpy_ctdsf(pnts: Vector, veca: Vector, vecb: Vector,
                vecc: Vector, *, betx: float = 1.0,
                bety: float = 1.0, betz: float = 1.0,
                tol: float = 1e-12, cond: float = 0.0) -> tuple[Flow, Flow]:
